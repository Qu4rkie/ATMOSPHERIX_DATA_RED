...
REP_DATA = "/user/home/yarivv/ATMOSPHERIX_DATA_RED/pickle/reduced/"
filename = ["TOI2109_06-05-25_NIRPS_5pc_reduced.pkl",
    "TOI2109_08-05-25_NIRPS_5pc_reduced.pkl",
    "TOI2109_10-05-25_NIRPS_5pc_reduced.pkl",
    "TOI2109_06-06-25_NIRPS_5pc_reduced.pkl"]


dir_res = "/user/home/yarivv/ATMOSPHERIX_DATA_RED/pickle/MCMC/"
name_fin = ["TOI2109_06-05-25_NIRPS_5pc_reduced_MCMC.pkl",
    "TOI2109_08-05-25_NIRPS_5pc_reduced_MCMC.pkl",
    "TOI2109_10-05-25_NIRPS_5pc_reduced_MCMC.pkl",
    "TOI2109_06-06-25_NIRPS_5pc_reduced_MCMC.pkl"]

for ind in range(len(filename)):

    with open(REP_DATA+filename[ind],'rb') as ccfile:
    ...
    with open(dir_res+name_fin[ind], 'wb') as specfile:
